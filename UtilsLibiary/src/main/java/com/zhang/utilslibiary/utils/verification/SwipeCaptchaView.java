...
import static com.zhang.utilslibiary.utils.verification.DrawHelper.drawPartCircle;
/**
 * 滑动验证码的View
...
public class SwipeCaptchaView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mMatchDeviation = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 12, getResources().getDisplayMetrics());
...
//        mSuccessAnim.setInterpolator(new FastOutLinearInInterpolator());
        ...
        mSuccessAnim.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                isShowSuccessAnim = false; // 开启这个会有白光闪过.
            }
...
//        isDrawMask = true;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isMatchMode) {
            ...
            //绘制滑块
            // isDrawMask  绘制失败闪烁动画用// && isDrawMask
