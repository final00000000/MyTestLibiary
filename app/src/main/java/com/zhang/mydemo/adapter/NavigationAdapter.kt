package com.zhang.mydemo.adapter
...
class NavigationAdapter constructor(context: Context) :
    ...
    inner class ViewHolder : AppViewHolder(R.layout.main_navigation_item) {
        ...
        private val iconView: ImageView? by lazy { findViewById(R.id.iv_main_navigation_icon) }
        private val titleView: TextView? by lazy { findViewById(R.id.tv_main_navigation_title) }
