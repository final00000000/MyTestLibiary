...
import com.alipay.mobile.scansdk.ui.ScanRayView;
...
public class ScanView extends RelativeLayout {
    ...
    private void init(Context ctx) {
        ...
        ScaleFinderView finderView = (ScaleFinderView) findViewById(R.id.finder_view);
        mRayView = (ScanRayView) findViewById(R.id.ray_view);
