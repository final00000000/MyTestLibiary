...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    /*收起文字*/
    private String textCollapse = "收起";
    /*展开文字*/
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mExpandDrawable == null) {
            mExpandDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_collapse);
        }
        if (mCollapseDrawable == null) {
            mCollapseDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_expand);
        }

        /*if (TextUtils.isEmpty(textCollapse)) {
            textCollapse = getContext().getString(R.string.social_contract);
        }
