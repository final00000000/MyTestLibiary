    ...
    init {
        ...
        normalDrawable = ContextCompat.getDrawable(
            getContext(), array.getResourceId(
                R.styleable.SimpleRatingBar_normalDrawable, R.drawable.ic_star_yellow_normal
            )
        )!!
        halfDrawable = ContextCompat.getDrawable(
            getContext(), array.getResourceId(
                R.styleable.SimpleRatingBar_halfDrawable, R.drawable.ic_star_yellow_normal
            )
        )// 半颗星星图片
        fillDrawable = ContextCompat.getDrawable(
            getContext(), array.getResourceId(
                R.styleable.SimpleRatingBar_fillDrawable, R.drawable.ic_star_yellow_selected
            )
        )!!
