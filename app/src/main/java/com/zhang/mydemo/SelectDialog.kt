...
import com.zhang.mydemo.adapter.AppAdapter
import com.zhang.mydemo.adapter.BaseAdapter
            ...
            when (view.id) {
                R.id.tv_ui_confirm -> {
                    ...
                    if (data.size >= adapter.getMinSelect()) {
                        ...
                        Toasty.normal(String.format(getString(R.string.select_min_hint)!!))
                    }
                }
                R.id.tv_ui_cancel -> {
                    autoDismiss()
        ...
        override fun onItemClick(recyclerView: RecyclerView?, itemView: View?, position: Int) {
            if (selectSet.containsKey(position)) {
                ...
                if (selectSet.size < maxSelect) {
                    ...
                    Toasty.normal(String.format(getString(R.string.select_max_hint)!!))
                }
            }
        }
